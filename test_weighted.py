...
# def load_imbalance_models():
#     model_imbalance = IR_50([224,224]).cuda()
...
#         new_state_dict[name] = v
#     #import pdb; pdb.set_trace()
#     model_imbalance.load_state_dict(new_state_dict, strict = True)
#     model_imbalance.eval()
#     return model_imbalance
...
def main_test():
    ...
    for i in range(total_cnt):
        ...
        #fusion avg threshold
        #threshold = [0.5802255272865295, 0.540743350982666, 0.5851588845252991, 0.7234406471252441, 0.5766499042510986, 0.6436299681663513, 0.6244972348213196, 0.6051139831542969, 0.5741651654243469, 0.5530682802200317, 0.5654063820838928, 0.7256962656974792, 0.6315457820892334, 0.5606924891471863, 0.5526134371757507, 0.5548810362815857, 0.5940477252006531, 0.5528343915939331, 0.5556425452232361, 0.6339707374572754, 0.5435442328453064, 0.5427368879318237, 0.5414750576019287]
